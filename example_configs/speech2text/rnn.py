...
## now fix some variables

# enable cudnn if required
if "cudnn" in rnn_type: use_cudnn_rnn = True
else: use_cudnn_rnn = False
...
base_params = {
    ...
    "decoder_params": {
        "use_language_model": False,  # False for training. For test maybe enable? It's slow...
