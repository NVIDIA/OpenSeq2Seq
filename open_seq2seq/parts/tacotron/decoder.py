...
#     # print(initial_inputs.get_shape())

#     initial_outputs_ta = nest.map_structure(_create_ta, decoder.output_size,
#                                             decoder.output_dtype)
#     initial_inputs_ta = nest.map_structure(_create_ta, initial_inputs.get_shape()[-1],
#                                             dtypes.float32)

#     def condition(unused_time, unused_outputs_ta, unused_state, unused_inputs,
#                   finished, unused_sequence_lengths, inputs_ta):
#       return math_ops.logical_not(math_ops.reduce_all(finished))

#     def body(time, outputs_ta, state, inputs, finished, sequence_lengths, inputs_ta):
...
#                                       outputs_ta, emit)
#       inputs_ta = nest.map_structure(lambda ta, inp: ta.write(time, inp),
#                                       inputs_ta, next_inputs)
#       return (time + 1, outputs_ta, next_state, next_inputs, next_finished,
#               next_sequence_lengths, inputs_ta)
...
#             initial_finished, initial_sequence_lengths, initial_inputs_ta
#         ],
...
#     final_inputs = nest.map_structure(lambda ta: ta.stack(), inputs)
...
#       final_inputs = nest.map_structure(_transpose_batch_time, final_inputs)

#   return final_outputs, final_state, final_sequence_lengths, final_inputs
