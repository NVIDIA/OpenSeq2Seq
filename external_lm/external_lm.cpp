...
ExternalLanguageModel::ExternalLanguageModel(const char* path_to_traced_pytorch_model,
...
float ExternalLanguageModel::score_phrase(std::vector<std::string> words) {
