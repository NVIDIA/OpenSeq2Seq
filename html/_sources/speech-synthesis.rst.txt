...
<https://github.com/NVIDIA/OpenSeq2Seq/blob/18.11/scripts/tacotron_save_spec.py>`_. 
...
<https://github.com/NVIDIA/OpenSeq2Seq/blob/18.11/scripts/wavenet_naive_infer.py>`_ 
