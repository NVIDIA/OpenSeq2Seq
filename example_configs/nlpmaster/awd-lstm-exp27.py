...
base_params = {
  ...
  "encoder_params": { # will need to update
    ...
    "encoder_dp_output_keep_prob": 0.5, # output dropout for middle layer 0.3
    "encoder_last_input_keep_prob": 1.0,
    "encoder_last_output_keep_prob": 0.5, # output droput at last layer is 0.4
