...
class ParallelTextDataLayer(DataLayer):
  ...
  def __init__(self, params, model, num_workers=1, worker_id=0):
    ...
    # unknown symbol
    unk_id = SpecialTextTokens.to_string(SpecialTextTokens.UNK_ID.value)
    self.src_seq2idx[unk_id] = SpecialTextTokens.UNK_ID.value
    self.tgt_seq2idx[unk_id] = SpecialTextTokens.UNK_ID.value

    # sentence start
    start_id = SpecialTextTokens.to_string(SpecialTextTokens.S_ID.value)
    self.src_seq2idx[start_id] = SpecialTextTokens.S_ID.value
    ...
    # padding
    pad_id = SpecialTextTokens.to_string(SpecialTextTokens.PAD_ID.value)
    self.src_seq2idx[pad_id] = SpecialTextTokens.PAD_ID.value
    self.tgt_seq2idx[pad_id] = SpecialTextTokens.PAD_ID.value
  ...
  def build_graph(self):
    ...
    def src_token_to_id(line):
      ...
      return np.array(
          pad2eight(
              ...
              [self.src_seq2idx.get(token, SpecialTextTokens.UNK_ID.value)
               for token in tokens] +
              [SpecialTextTokens.EOS_ID.value],
              self._pad_lengths_to_eight
          ),
          dtype="int32",
      )
    ...
    def tgt_token_to_id(line):
      ...
      return np.array(
          pad2eight(
              [SpecialTextTokens.S_ID.value] +
              [self.tgt_seq2idx.get(token, SpecialTextTokens.UNK_ID.value)
               for token in tokens] +
              [SpecialTextTokens.EOS_ID.value],
              self._pad_lengths_to_eight
          ),
